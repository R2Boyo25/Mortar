...
template<typename T>
struct is_std_chrono_system_clock_time_point : boost::false_type {};
template<typename Duaration>
struct is_std_chrono_system_clock_time_point<
    std::chrono::time_point<std::chrono::system_clock, Duaration> >
: boost::true_type {};
